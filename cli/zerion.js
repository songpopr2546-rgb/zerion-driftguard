...
import agentCreateDriftguardPolicy from "./commands/agent/create-driftguard-policy.js";
import agentRunDriftguard from "./commands/agent/run-driftguard.js";
...
register("agent", "create-driftguard-policy", agentCreateDriftguardPolicy);
register("agent", "run-driftguard", agentRunDriftguard);
